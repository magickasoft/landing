    ...
    <Container>
      <Content>
        <RightColumn>
          ...
          <Text>
            Люди — самый ценный актив нашего бизнеса, поэтому мы создаем максимально комфортную и продуктивную среду для работы сотрудников. Станьте частью нашей команды и работайте над проектом, о котором вы с интересом будете рассказывать другим.
          </Text>
          <Link
            target="_blank"
